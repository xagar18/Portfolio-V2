  ...
  return ( 
    <section className="w-full h-full flex flex-col justify-center items-center px-8 pt-24 animate-fade-in-up"> 
      <h1 className="text-6xl md:text-7xl font-bold font-grotesk tracking-tight mb-3 animate-fade-in-up text-primary"> 
        Hi, <span className="text-primary">I'm Sagar Yadav</span> 
      </h1> 
      <div className="mb-8 text-base md:text-lg text-muted-foreground font-semibold tracking-wide animate-fade-in-up" style={{ animationDelay: ".08s" }}> 
        Full-Stack Developer • Seamless Digital Experiences 
      </div> 
      <p className="max-w-xl text-xl md:text-2xl font-normal text-muted-foreground text-center mb-12 animate-fade-in-up" style={{ animationDelay: "0.15s" }}> 
        I build scalable, high-performance applications that merge functionality with intuitive design.<br />
